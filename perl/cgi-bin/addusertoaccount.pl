...
printHeader("Users on Account", "What users have access to this account");
...
#}
#
#database::getAllAccountsOwned($userId);
#
#my $acctList = $database::resRef;
#
## start of the HTML
#print $curSess->header(),
#      $cgi->start_html(-title => "Add User to Account",
...
#print "<h1>Add User To Account</h1>\n";
#
#print '<div class="subheading">Account List</div>\n';
#foreach my $curAcct (@$acctList)
#{
#	print <<endHTML;
#        <a href="$thisScript?acct_id=$curAcct->{'acct_id'}&submit=
#}
#
#if ($dbError)
#{
